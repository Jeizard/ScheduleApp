...
public class GroupWithFullInformation {
    private int id;
    ...
    public GroupWithFullInformation(int id, String number, Boolean isLocal, String specialityTitle, String specialityAbbreviation, String facultyTitle, String facultyAbbreviation, String studyYearNumber, String educationFormTitle) {
        this.id = id;
        this.number = number;
