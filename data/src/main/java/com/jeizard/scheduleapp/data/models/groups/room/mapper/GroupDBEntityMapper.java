package com.jeizard.scheduleapp.data.models.groups.room.mapper;
...
public class GroupDBEntityMapper implements Mapper<GroupDBEntity, Group> {
    ...
    public Group mapFromDBEntity(GroupDBEntity groupDBEntity) {
        ...
        if (groupDBEntity != null) {
            group = new Group(groupDBEntity.getId(), groupDBEntity.getNumber());
        }
        return group;
    }
    ...
    public GroupDBEntity mapToDBEntity(Group group) {
        ...
        if (group != null) {
            groupDBEntity = new GroupDBEntity(group.getId(), group.getNumber());
        }
