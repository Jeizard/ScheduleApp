package com.jeizard.scheduleapp.data.models.composite_models.lesson_with_fullinformation.entity;

import java.sql.Time;

public class LessonWithFullInformationDataEntity {
    private int id;
    ...
    public LessonWithFullInformationDataEntity(int id, Time startTime, Time endTime, String weekDayTitle, String weekDayAbbreviation, String subjectTitle, String subjectAbbreviation, String teacherSurname, String teacherName, String teacherPatronymic, String cabinetNumber, String typeTitle, String typeAbbreviation) {
        this.id = id;
